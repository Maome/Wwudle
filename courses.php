                ...
                <div class="span9">
                    <div class="row-fluid">
                        ...
                        <div class="span4 offset2">
                            <a class="btn btn-success" type="button" href="coursesadd.html">Review a course</a>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="span6 offset1">
                            <form class="form-inline">
                                <input class="input-medium" type="text" placeholder="course">
